    ...
    if ($stmt->affected_rows > 0) {
        ...
        if ($countRow && $countRow['count'] >= 3) {
          ...
          < body style =\"font-family: 'Inter', sans-serif; background-color: #f1f5f9; padding: 20px; margin: 0;\">
           ...
           _    < li style =\"margin-bottom: 12px; color: #475569;\"><strong>Código de Defecto:</strong> <span style=\"font-weight: bold; color: #D32F2F; font-family: monospace;\">{$codigoDefecto}</span></li>
